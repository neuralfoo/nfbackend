...
def accuracy_testcontroller_testcase_add():
    ...
    try:
        ...
        result,msg = functions.add_testcase(testboardID,requestVariables,responseVariables)
...
@profile.route("/app/testcontroller/accuracytest/testcase/import",methods=["POST"])
def accuracy_testcontroller_testcase_import():

    endpoint = "/app/testcontroller/accuracytest/testcase/import"
    ...
    try:
        ...
        logger.info(f"Accuracy test cases IMPORT attempt by user {userID}")
